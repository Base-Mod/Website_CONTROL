...
<head>
    ...
    <title>Cảnh báo - Hệ thống giám sát điện năng</title>
        ...
        <main class="main-content">
            <header class="page-header">
                ...
                <div class="header-actions">
                    <button class="btn btn-sm" onclick="markAllRead()">✓ Đánh dấu tất cả đã đọc</button>
                    <button class="btn btn-sm" onclick="loadAlerts()">🔄 Làm mới</button>
                </div>
            </header>
